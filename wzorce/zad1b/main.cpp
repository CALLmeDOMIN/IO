...
public:
  void buildDough() override { pizza.setDough("Pan Dough"); }
  void buildSauce() override { pizza.setSauce("Hawaiian Sauce"); }
...
public:
  void buildDough() override { pizza.setDough("Thin Dough"); }
  void buildSauce() override { pizza.setSauce("Spicy Tomato Sauce"); }
  void buildTopping() override { pizza.setTopping("Pepperoni and Jalapenos"); }
  Pizza getPizza() const override { return pizza; }
...
class SieronPizzaBuilder : public PizzaBuilder {
public:
  void buildDough() override { pizza.setDough("Thin Dough"); }
  void buildSauce() override { pizza.setSauce("BBQ Sauce"); }
  void buildTopping() override { pizza.setTopping("Chicken and onion"); }
  Pizza getPizza() const override { return pizza; }
...
int main() {
  ...
  SieronPizzaBuilder sieronBuilder;
  cook.makePizza(sieronBuilder);
  Pizza sieronPizza = sieronBuilder.getPizza();
  sieronPizza.displayPizza();
}